  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative">
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-brand-500/6 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-accent-500/4 rounded-full blur-[100px]" />
      </div>
      ...
      >
        <div className="glass-card p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-light-text mb-1">Welcome Back</h2>
            <p className="text-light-text-secondary text-sm">Sign in to your DevMarket account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a href="#" className="text-xs text-brand-600 hover:text-brand-500 transition-colors">Forgot password?</a>
              </div>
              <div className="relative">
            ...
            <button type="submit" className="btn-primary w-full py-3.5 text-base relative overflow-hidden group">
          ...
          <div className="text-center text-sm text-light-text-secondary">
            Don't have an account? <Link to="/register" className="text-brand-600 hover:text-brand-500 font-medium transition-colors">Sign up</Link>
          </div>
        </div>
      </motion.div>
    </div>
